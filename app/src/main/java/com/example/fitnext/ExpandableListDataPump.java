...
public class ExpandableListDataPump {
    ...
    public static HashMap<String, List<String>> getData() {
        ...
        que1.add("Preventing diabetes involves adopting a proactive approach to managing lifestyle factors. One crucial aspect is maintaining a healthy weight through a balanced diet and regular physical activity. This includes consuming plenty of fruits, vegetables, whole grains, and lean proteins while minimizing intake of processed foods and sugary beverages. Engaging in regular exercise, aiming for at least 150 minutes of moderate-intensity aerobic activity per week, helps improve insulin sensitivity and regulate blood sugar levels. Additionally, avoiding smoking and limiting alcohol consumption to moderate levels can reduce the risk of developing diabetes.");
        ...
        expandableListDetail.put("How to Prevent Diabetes?", que1);
