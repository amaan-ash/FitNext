...
public class ChatGPT_Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chatgpt_dashboard);
        ...
        if(!isConnected(ChatGPT_Dashboard.this)) {
            buildDialog(ChatGPT_Dashboard.this).show();
        }
